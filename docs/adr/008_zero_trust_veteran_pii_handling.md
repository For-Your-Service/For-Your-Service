# ADR-008: Zero-Trust Security for Veteran PII and Resumes
...
## 💡 Decision
Enforced strict local parsing for resumes with immediate memory disposal; never persist raw veteran PII or DD-214 records to unencrypted disks.
