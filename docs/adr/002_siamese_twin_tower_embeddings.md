# ADR-002: Dual-Tower Neural Semantic Matching Architecture
...
## 💡 Decision
Utilized sentence-transformers/all-MiniLM-L6-v2 dual-tower cosine similarity network to decouple veteran profile encoding from live job vectorization.
