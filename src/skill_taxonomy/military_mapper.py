...
class MilitarySkillMapper:
    ...
    def __init__(self):
        ...
        self.navy_ratings = {
            ...
            "CTN": MilitaryRole(
                ...
                civilian_equivalent="Cybersecurity Analyst",
                skills=["Cybersecurity", "Network Defense", "Cryptography", "Penetration Testing"],
    ...
    def enrich_resume_with_military_skills(self, resume_data: Dict) -> Dict:
        ...
        resume_data["civilian_equivalent_title"] = self.get_civilian_equivalent(
            military_mos, military_branch
        )
