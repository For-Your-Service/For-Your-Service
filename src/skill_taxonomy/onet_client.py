...
class ONetClient:
    ...
    def search_occupations(self, keyword: str, limit: int = 10) -> List[Dict]:
        ...
        """
        try:
            result = self._make_request("online/search", params={"keyword": keyword, "end": limit})
            return result.get("occupation", [])
        except Exception as e:
            print("O*NET search error: {e}")
            return []
    ...
    def get_occupation_details(self, onet_code: str) -> Dict:
        ...
        """
        try:
            return self._make_request("online/occupations/{onet_code}")
        except Exception as e:
            print("O*NET occupation details error: {e}")
            return {}
    ...
    def get_skills(self, onet_code: str) -> List[Dict]:
        ...
        """
        try:
            result = self._make_request("online/occupations/{onet_code}/skills")
            return result.get("skill", [])
        except Exception as e:
            print("O*NET skills error: {e}")
            return []
    ...
    def get_knowledge(self, onet_code: str) -> List[Dict]:
        ...
        """
        try:
            result = self._make_request("online/occupations/{onet_code}/knowledge")
            return result.get("knowledge", [])
        except Exception as e:
            print("O*NET knowledge error: {e}")
            return []
    ...
    def get_abilities(self, onet_code: str) -> List[Dict]:
        ...
        """
        try:
            result = self._make_request("online/occupations/{onet_code}/abilities")
            return result.get("ability", [])
        except Exception as e:
            print("O*NET abilities error: {e}")
            return []
