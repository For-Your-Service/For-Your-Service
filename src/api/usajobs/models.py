...
class JobPosting(BaseModel):
    ...
    position_schedule: List[Dict[str, Any]] = Field(default_factory=list, alias="PositionSchedule")
...
class SearchResponse(BaseModel):
    ...
    def jobs(self) -> List[JobPosting]:
        ...
        return [
            item["MatchedObjectDescriptor"] for item in items if "MatchedObjectDescriptor" in item
        ]
