...
class JobDataIngestionPipeline:
    ...
    def fetch_adzuna_jobs(
        ...
        try:
            ...
            return {"error": str(e), "results": [], "fetched_at": datetime.now().isoformat()}
    ...
    def write_bronze_table(self, df, table_name: str = "job_matching_bronze"):
        """
    ...
    def normalize_to_silver(
        self, bronze_table: str = "job_matching_bronze", silver_table: str = "job_matching_silver"
    ):
        """
    ...
    def run_full_pipeline(
            ...
            for location in locations:
                try:
                    ...
                    summary["errors"].append(
                        {"keywords": keywords, "location": location, "error": str(e)}
                    )
        ...
        if self.spark and summary["jobs_fetched"] > 0:
            try:
                ...
                summary["errors"].append({"stage": "spark_processing", "error": str(e)})
        elif not self.spark:
