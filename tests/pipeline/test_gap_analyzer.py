...
import unittest
from src.pipeline.gap_analyzer import GapAnalyzer, SkillGap
...
class TestGapAnalyzer(unittest.TestCase):
    ...
    def test_recommendation_generation(self):
        ...
        result = self.analyzer.analyze(
            candidate_skills, job_requirements, candidate_experience_years=5
        )
    ...
    def test_experience_level_recommendations(self):
        ...
        # Junior candidate
        junior_result = self.analyzer.analyze(
            candidate_skills, job_requirements, candidate_experience_years=1
        )
        self.assertTrue(any("portfolio" in r.lower() for r in junior_result.recommendations))

        # Senior candidate
        senior_result = self.analyzer.analyze(
            candidate_skills, job_requirements, candidate_experience_years=15
        )
