...
import unittest
import numpy as np
from src.pipeline.job_matcher import JobMatcher, JobMatch, MatchResult
...
class TestJobMatcher(unittest.TestCase):
    ...
    def test_find_matches_basic(self):
        ...
        job_embeddings = [
            ("job1", np.array([1.0, 0.5, 0.8]), {
                "title": "DevOps Engineer",
                "company": "Tech Corp",
                "location": "Remote",
                "skills": ["AWS", "Kubernetes"]
            }),
            ("job2", np.array([0.2, 0.1, 0.3]), {
    ...
    def test_similarity_threshold_filtering(self):
        ...
        job_embeddings = [
            ("job1", np.array([0.5, 0.5]), {  # Lower similarity
                "title": "Job 1",
                "company": "Company 1",
                "location": "Remote",
                "skills": []
    ...
    def test_batch_matching(self):
        ...
        self.assertGreater(
            results["candidate1"].avg_similarity,
            results["candidate2"].avg_similarity
        )
