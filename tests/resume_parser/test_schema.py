...
from src.resume_parser.schema import SkillEntry, ExperienceEntry, EducationEntry, ResumeSchema
...
class TestSkillEntry(unittest.TestCase):
    ...
    def test_skill_creation(self):
        ...
        skill = SkillEntry(
            name="Python", category="Technical", proficiency="Expert", years_experience=5.0
        )
...
class TestExperienceEntry(unittest.TestCase):
    ...
    def test_experience_to_dict(self):
        ...
        exp = ExperienceEntry(title="Engineer", company="ACME", start_date=date(2020, 1, 1))
...
class TestResumeSchema(unittest.TestCase):
    ...
    def test_resume_creation(self):
        ...
        resume = ResumeSchema(
            full_name="Free Hall", email="whall4.wh@gmail.com", location="Greenville, SC"
        )
    ...
    def test_total_experience_calculation(self):
        ...
        exp1 = ExperienceEntry(
            title="Engineer", company="Corp", start_date=date(2020, 1, 1), end_date=date(2022, 1, 1)
        )
        ...
        resume = ResumeSchema(full_name="Test User", experience=[exp1, exp2], years_of_service=5.0)
    ...
    def test_resume_to_dict(self):
        ...
        resume = ResumeSchema(full_name="Free Hall", email="whall4.wh@gmail.com", skills=[skill])
